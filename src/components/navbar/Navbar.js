        ...
        <div className='relative flex h-20 items-center justify-between'>
          <div className='absolute inset-y-0 left-0 flex items-center md:hidden'>
            ...
            <button
              ...
              aria-expanded='false'
              onClick={() => setIsMobileMenuShow((prev) => !prev)}
            >
          ...
          {!session && (
            <div className='hidden md:block md:ml-6'>
              <div className='flex items-center'>
                {provider && Object.values(provider).map((item, index) => (
                  <button onClick={() => signIn('google')} key={index} className='flex items-center text-white bg-gray-700 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2'>
              ...
              <div className='relative ml-3'>
                <div>
                  <button
                    ...
                    aria-expanded='false'
                    aria-haspopup='true'
                    onClick={() => setIsProfileMenuShow((prev) => !prev)}
                  >
                    <span className='absolute -inset-1.5'></span>
